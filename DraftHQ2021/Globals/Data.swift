...
let iHBudget: Double = (12 * 260) * 0.60 //hitters are 60% of budget
...
var bNSB: Double { iHBudget * 0.05 } //5% allocation means kinda punting category
var bOBP: Double { iHBudget * 0.20 }
var bSLG: Double { iHBudget * 0.20 }

let iPBudget: Double = (12 * 260) * 0.40 //SP are 28% of budget//RP are 12% of budget
